...
public class SEC extends AppCompatActivity {
    ...
    private EditText SEC_d1,SEC_d2,SEC_d3,SEC_D1,SEC_D2,SEC_D3,SEC_L1,SEC_L2, SEC_L3,SEC_T1,SEC_T2,SEC_T3;
    private TextView SEC_fp1,SEC_fp2,SEC_fp3;
    private Button bt1,bt2,bt3;
    private LinearLayout fpSec;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ///设置ToolBar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_simple_SEC);
        setSupportActionBar(toolbar);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("简单扩张腔");
        if (actionBar != null) {
        ...
        //设置刷新动作
        swipeRefresh = (SwipeRefreshLayout) findViewById(R.id.swipe_refresh_sec);
        ...
        //初始化画板
        iv_canvas = (ImageView) findViewById(R.id.iv_canvas_SEC);
    ...
    private void initUI(){
        SEC_d1 = (EditText)findViewById(R.id.d_SEC_1);
        SEC_d2 = (EditText)findViewById(R.id.d_SEC_2);
        SEC_d3 = (EditText)findViewById(R.id.d_SEC_3);
        SEC_D1 = (EditText)findViewById(R.id.D_SEC_1);
        SEC_D2 = (EditText)findViewById(R.id.D_SEC_2);//?????
        SEC_D3 = (EditText)findViewById(R.id.D_SEC_3);
        SEC_L1 = (EditText)findViewById(R.id.L_SEC_1);
        SEC_L2 = (EditText)findViewById(R.id.L_SEC_2);
        SEC_L3 = (EditText)findViewById(R.id.L_SEC_3);
        SEC_T1 = (EditText)findViewById(R.id.T_SEC_1);
        SEC_T2 = (EditText)findViewById(R.id.T_SEC_2);
        SEC_T3 = (EditText)findViewById(R.id.T_SEC_3);
        bt1 = (Button)findViewById(R.id.bt_SEC_1);
        bt2 = (Button)findViewById(R.id.bt_SEC_2);
        bt3 = (Button)findViewById(R.id.bt_SEC_3);
        SEC_fp1 = (TextView)findViewById(R.id.fp_SEC_1);
        SEC_fp2 = (TextView)findViewById(R.id.fp_SEC_2);
        SEC_fp3 = (TextView)findViewById(R.id.fp_SEC_3);
        fpSec = (LinearLayout) findViewById(R.id.fp_SEC);
        fpSec.setVisibility(View.GONE);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String S_d1,S_D1,S_L1,S_T1;
                S_d1=SEC_d1.getText().toString();
                S_D1=SEC_D1.getText().toString();
                S_L1=SEC_L1.getText().toString();
                S_T1=SEC_T1.getText().toString();
                isFilled[0] = false;
                if(!S_d1.equals("") && !S_D1.equals("") && !S_L1.equals("") && !S_T1.equals("")){
                    isFilled[0] = true;
                    ...
                    TArray[0] = T;
                    printGraphic();
                    SEC_fp1.setText(String.valueOf(fp[0]));
                    fpSec.setVisibility(View.VISIBLE);
                }else{
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String S_d2,S_D2,S_L2,S_T2;
                S_d2=SEC_d2.getText().toString();
                S_D2=SEC_D2.getText().toString();
                S_L2=SEC_L2.getText().toString();
                S_T2=SEC_T2.getText().toString();
                isFilled[1] = false;
                if(!S_d2.equals("") && !S_D2.equals("") && !S_L2.equals("")&& !S_T2.equals("")){
                    isFilled[1] = true;
                    ...
                    TArray[1] = T;
                    printGraphic();
                    SEC_fp2.setText(String.valueOf(fp[1]));
                    fpSec.setVisibility(View.VISIBLE);
                }else{
                    Toast.makeText(getContext(),"请输入完整数据",Toast.LENGTH_SHORT).show();
                }
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String S_d3,S_D3,S_L3,S_T3;
                S_d3=SEC_d3.getText().toString();
                S_D3=SEC_D3.getText().toString();
                S_L3=SEC_L3.getText().toString();
                S_T3=SEC_T3.getText().toString();
                isFilled[2] = false;
                if(!S_d3.equals("") && !S_D3.equals("") && !S_L3.equals("")&& !S_T3.equals("")){
                    isFilled[2] = true;
                    ...
                    TArray[2] = T;
                    printGraphic();
                    SEC_fp3.setText(String.valueOf(fp[2]));
                    fpSec.setVisibility(View.VISIBLE);
                }else{
                    Toast.makeText(getContext(),"请输入完整数据",Toast.LENGTH_SHORT).show();
                }
    ...
    private void printGraphic() {
        ...
        for(int j=0; j<3; j++){
            ...
            fp[j]=(int)(1.0/4*c0/(L*0.001));
            for (int i = minHor; i <= maxHor; i++) {
                m=D*D/d/d;
                f=i;
                kl=2*PI*f/c0*L/1000;
                in=(m-1/m)/2*Math.sin(kl);
