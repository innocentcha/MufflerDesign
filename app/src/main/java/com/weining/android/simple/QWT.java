...
public class QWT extends AppCompatActivity {
    private double d,D,L,tw,T;
    ...
    private EditText QWT_d1,QWT_d2,QWT_d3,QWT_D1,QWT_D2,QWT_D3,QWT_L1,QWT_L2, QWT_L3,QWT_tw1,QWT_tw2, QWT_tw3,QWT_T1,QWT_T2, QWT_T3;
    private TextView QWT_fp1,QWT_fp2,QWT_fp3;
    private Button bt1,bt2,bt3;
    private LinearLayout fpQwt;
    //下拉刷新
...
//    double max;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qwt);

        ///设置ToolBar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_simple_QWT);
        setSupportActionBar(toolbar);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("1/4 波长管");
        if (actionBar != null) {
        ...
        //设置刷新动作
        swipeRefresh = (SwipeRefreshLayout) findViewById(R.id.swipe_refresh_qwt);
        ...
        //初始化画板
        iv_canvas = (ImageView) findViewById(R.id.iv_canvas_QWT);
    ...
    private void initUI(){
        QWT_d1 = (EditText)findViewById(R.id.d_QWT_1);
        QWT_d2 = (EditText)findViewById(R.id.d_QWT_2);
        QWT_d3 = (EditText)findViewById(R.id.d_QWT_3);
        QWT_D1 = (EditText)findViewById(R.id.D_QWT_1);
        QWT_D2 = (EditText)findViewById(R.id.D_QWT_2);
        QWT_D3 = (EditText)findViewById(R.id.D_QWT_3);
        QWT_L1 = (EditText)findViewById(R.id.L_QWT_1);
        QWT_L2 = (EditText)findViewById(R.id.L_QWT_2);
        QWT_L3 = (EditText)findViewById(R.id.L_QWT_3);
        QWT_T1 = (EditText)findViewById(R.id.T_QWT_1);
        QWT_T2 = (EditText)findViewById(R.id.T_QWT_2);
        QWT_T3 = (EditText)findViewById(R.id.T_QWT_3);
        QWT_tw1 = (EditText)findViewById(R.id.tw_QWT_1);
        QWT_tw2 = (EditText)findViewById(R.id.tw_QWT_2);
        QWT_tw3 = (EditText)findViewById(R.id.tw_QWT_3);
        bt1 = (Button)findViewById(R.id.bt_QWT_1);
        bt2 = (Button)findViewById(R.id.bt_QWT_2);
        bt3 = (Button)findViewById(R.id.bt_QWT_3);
        QWT_fp1 = (TextView)findViewById(R.id.fp_QWT_1);
        QWT_fp2 = (TextView)findViewById(R.id.fp_QWT_2);
        QWT_fp3 = (TextView)findViewById(R.id.fp_QWT_3);
        fpQwt = (LinearLayout) findViewById(R.id.fp_QWT);
        fpQwt.setVisibility(View.GONE);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String S_d1,S_D1,S_L1,S_tw1,S_T1;
                S_d1=QWT_d1.getText().toString();
                S_D1=QWT_D1.getText().toString();
                S_L1=QWT_L1.getText().toString();
                S_T1=QWT_T1.getText().toString();
                S_tw1=QWT_tw1.getText().toString();
                isFilled[0] = false;
                if(!S_d1.equals("") && !S_D1.equals("") && !S_L1.equals("") && !S_T1.equals("") && !S_tw1.equals("")){
                    isFilled[0] = true;
                    ...
                    TArray[0] = T;
                    printGraphic();
                    QWT_fp1.setText(String.valueOf(fp[0]));
                    fpQwt.setVisibility(View.VISIBLE);
                }else{
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String S_d2,S_D2,S_L2,S_T2,S_tw2;
                S_d2=QWT_d2.getText().toString();
                S_D2=QWT_D2.getText().toString();
                S_L2=QWT_L2.getText().toString();
                S_T2=QWT_T2.getText().toString();
                S_tw2=QWT_tw2.getText().toString();
                isFilled[1] = false;
                if(!S_d2.equals("") && !S_D2.equals("") && !S_L2.equals("") && !S_T2.equals("") && !S_tw2.equals("")){
                    isFilled[1] = true;
                    ...
                    TArray[1] = T;
                    printGraphic();
                    QWT_fp2.setText(String.valueOf(fp[1]));
                    fpQwt.setVisibility(View.VISIBLE);
                }else{
                    Toast.makeText(getContext(),"请输入完整数据",Toast.LENGTH_SHORT).show();
                }
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String S_d3,S_D3,S_L3,S_tw3,S_T3;
                S_d3=QWT_d3.getText().toString();
                S_D3=QWT_D3.getText().toString();
                S_L3=QWT_L3.getText().toString();
                S_T3=QWT_T3.getText().toString();
                S_tw3=QWT_tw3.getText().toString();
                isFilled[2] = false;
                if(!S_d3.equals("") && !S_D3.equals("") && !S_L3.equals("") && !S_T3.equals("") && !S_tw3.equals("")){
                    isFilled[2] = true;
                    ...
                    TArray[2] = T;
                    printGraphic();
                    QWT_fp3.setText(String.valueOf(fp[2]));
                    fpQwt.setVisibility(View.VISIBLE);
                }else{
                    Toast.makeText(getContext(),"请输入完整数据",Toast.LENGTH_SHORT).show();
                }
    ...
    private void printGraphic() {
        ...
        for(int j=0; j<3; j++) {
            ...
            fp[j]=(int)(0.25*c0/Leq*1000);
            for (int i = minHor; i <= maxHor; i++) {
                f=i;
                in=m*Math.tan(2*PI*f/c0*Leq/1000);
                TL=10*Math.log10(1+0.25*in*in);
