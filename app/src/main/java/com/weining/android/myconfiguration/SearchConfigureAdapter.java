...
public class SearchConfigureAdapter extends RecyclerView.Adapter<SearchConfigureAdapter.ViewHolder> {
            ...
            public void onClick(View v) {
                ...
                for (int j = 0; j < btString.length(); j++) {
                    if (btString.charAt(j) <= '9' && btString.charAt(j) >= '0') {
                        //之前只取到第一个数字 忽略了不止一个数字的情况
                        myPosition = myPosition * 10 + btString.charAt(j) - '0';
                    }
                }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //TODO 将color放在colors.xml里面
        if (id % 15 == 1) {
            holder.configureName.setTextColor(0xFF4A7EBB);
        } else if (id % 15 == 2) {
            holder.configureName.setTextColor(0xFFBE4B48);
        } else if (id % 15 == 3) {
            holder.configureName.setTextColor(0xFF98B954);
        } else if (id % 15 == 4) {
            holder.configureName.setTextColor(0xFF495A80);
        } else if (id % 15 == 5) {
            holder.configureName.setTextColor(0xFFFD5B78);
        } else if (id % 15 == 6) {
            holder.configureName.setTextColor(0xFF9DC8C8);
        } else if (id % 15 == 7) {
            holder.configureName.setTextColor(0xFFE53A40);
        } else if (id % 15 == 8) {
            holder.configureName.setTextColor(0xFFA593E0);
        } else if (id % 15 == 9) {
            holder.configureName.setTextColor(0xFF5A9367);
        } else if (id % 15 == 10) {
            holder.configureName.setTextColor(0xFFCFAA9E);
        } else if (id % 15 == 11) {
            holder.configureName.setTextColor(0xFFEF5285);
        } else if (id % 15 == 12) {
            holder.configureName.setTextColor(0xFF56A902);
        } else if (id % 15 == 13) {
            holder.configureName.setTextColor(0xFF71226E);
        } else if (id % 15 == 14) {
            holder.configureName.setTextColor(0xFF99F19E);
        } else if (id % 15 == 0) {
            holder.configureName.setTextColor(0xFF376956);
        }
